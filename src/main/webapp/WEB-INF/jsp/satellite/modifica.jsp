	   ...
	   <body class="d-flex flex-column h-100">
			...
			<main class="flex-shrink-0">
			  <div class="container">
					...
					<spring:hasBindErrors  name="modifica_satellite_attr">
						<%-- alert errori --%>
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form:form modelAttribute="modifica_satellite_attr" method="post" action="${pageContext.request.contextPath}/satellite/salvamodifica" class="row g-3" novalidate="novalidate">
							
							<input type="hidden" name="id" value='${modifica_satellite_attr.id}'>
								<div class="col-md-6">
									<label for="denominazione" class="form-label">Denominazione <span class="text-danger">*</span></label>
									<spring:bind path="denominazione">
										<input type="text" name="denominazione" id="denominazione" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire la denominazione" value="${modifica_satellite_attr.denominazione }" required>
									</spring:bind>
								...
								<div class="col-md-6">
									...
									<spring:bind path="codice">
										<input type="text" name="codice" id="codice" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il codice" value="${modifica_satellite_attr.codice }" required>
									</spring:bind>
									<form:errors  path="codice" cssClass="error_field" />
								</div>
							
								<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date' value='${modifica_satellite_attr.dataLancio}' />
								<div class="col-md-3">
								...
								<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date' value='${modifica_satellite_attr.dataRientro}' />
								<div class="col-md-3">
