			...
			<main class="flex-shrink-0">
			  <div class="container">
			  		...
			  		<div class='card'>
					    ...
					    <form action="${pageContext.request.contextPath}/satellite/salvadelete" method="post">
					    ...
					    <div class='card-footer'>
					        <a href="${pageContext.request.contextPath}/satellite/salvadelete/${delete_satellite_attr.id}" class='btn btn-outline-danger' style='width:90px'>
